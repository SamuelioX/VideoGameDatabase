...
--
-- Dumping data for game_genregame_genretable `user`
--

LOCK TABLES `user` WRITE;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` VALUES (1,4,'admin',NULL,'admin@videogamedb.com','password');
...
INSERT INTO `video_game_info` VALUES (1,'Mega Man X2','Capcom','Capcom',NULL,10,2,0,'E'),(2,'Mega Man X3','Capcom','Capcom',NULL,7,2,0,'E');
...
-- Dump completed on 2017-04-10 13:39:20
